...
const RULES: Record<string, Rule> = {
  ...
  "creature.eyeOffsetX": { min: 0, max: 2, note: "forward face-edge eye offset; eyes stay immediately inboard of the external-gill fans" },
  "creature.eyeOffsetY": { min: -1, max: 2, note: "forward-crown eye height; shells remain above the first gill roots and break the rear silhouette" },
  "creature.eyeOffsetZ": { min: -2, max: 2, note: "eye depth offset; negative values keep the complete lens on the obstacle-facing side and ahead of every gill root" },
