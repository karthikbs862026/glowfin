...
const RULES: Record<string, Rule> = {
  ...
  "creature.eyeOffsetX": { min: 0, max: 2, note: "eye lateral offset as a multiple of creatureRadius on the obstacle-facing side" },
  "creature.eyeOffsetY": { min: -1, max: 2, note: "eye height offset" },
  "creature.eyeOffsetZ": { min: -2, max: 0, note: "eye forward offset; Glowfin travels toward negative Z, so positive values incorrectly face the chase camera" },
