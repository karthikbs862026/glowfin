...
const RULES: Record<string, Rule> = {
  ...
  "creature.eyeOffsetX": { min: 0, max: 2, note: "outer face-edge eye offset; eyes sit immediately inside the external-gill fans" },
  "creature.eyeOffsetY": { min: -1, max: 2, note: "face-edge eye height; eyes remain between the upper and middle gill leaves" },
  "creature.eyeOffsetZ": { min: -2, max: 2, note: "eye depth offset; the complete lens stays forward of every gill root while the lateral edge remains chase-camera visible" },
