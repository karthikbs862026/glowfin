...
const RULES: Record<string, Rule> = {
  ...
  "creature.eyeOffsetX": { min: 0, max: 2, note: "lateral face-edge eye offset; eyes sit immediately inside the external-gill fans" },
  "creature.eyeOffsetY": { min: -1, max: 2, note: "face-edge eye height; eyes remain between the upper and middle gill leaves" },
  "creature.eyeOffsetZ": { min: -2, max: 2, note: "eye depth offset; positive values expose only the lateral rear-readable cap to the chase camera" },
