...
const RULES: Record<string, Rule> = {
  ...
  "creature.eyeOffsetX": { min: 0, max: 2, note: "high lateral eye offset; the eyes must peek around the rear silhouette without forming a camera-facing facial mask" },
  "creature.eyeOffsetY": { min: -1, max: 2, note: "eye height offset" },
  "creature.eyeOffsetZ": { min: -2, max: 2, note: "eye depth offset; side-set crown eyes remain visible from the chase camera while the authored swim axis stays negative Z" },
