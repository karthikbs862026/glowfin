...
2. Build population heads from a warm nacre facial plane, high hairline, two
   separated eye-white/iris/highlight stacks, a curved smile and soft cheeks.
...
3. Keep reef citizens and conch heralds vertical and spatially anchored with
   only subtle asynchronous idle drift. Place the two swimmers on opposite
...
5. Sample every choreography path across both guardian sides and reject any
   ...
   units.
6. Extend phone evidence from one frame to a 3.25-second time-lapse. Reject
...
7. Keep owner phone review authoritative. These measurements prevent a false
...
budgets. Citizen, swimmer and herald prototypes measure 1,720, 1,780 and 2,072
